...
var   Y, Disp, C, H, Mu, M,Int_new , Int_D, D, D_new, Tau, Tax_obs,Mu_obs,        
      Q1, Pie, Lambda , Mc,Int ,AW,Z1,Z2,
      Q2, Ptild, W, DG,A_t ,Dbs,DI_obs,Rrate,Delta, 
      Y_obs  Int_obs Int_new_obs Pie_obs H_obs W_obs C_obs Tau_obs D_obs D_new_obs Int_D_obs 
      PIESTAR EPSI_R PIESTAR_frcst PIESTAR_est EPSI_R_est EPSI_R_frcst ETA_PIE_est ETA_R_est
      M_obs PIESTAR4      
      Mcn Wn Z1n ,Z2n,Lambdan ,Taun,Hn ,Mn,D_newn Int_Dn,Dn ,Rn,Pien,Yn,
      Cn,Taun_obs,Yn_obs,Int_newn,Mun,Intn,Dn_obs;
...
parameters 
           ...
           Lambdas, Cs,Disps ,alphaa ,B0,DHS,kappa ,gamma1w,markupw ,phiw,sigmam,SMY,
           gamma1, gamma2, betta, phi,epsi , epsps, Pies,Int_news,D_news, Int_Ds,
