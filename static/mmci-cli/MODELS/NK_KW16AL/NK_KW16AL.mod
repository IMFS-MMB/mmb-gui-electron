...
AL_Info.forwards =     {'C','Rd','Lambda','I','Q','infl','F','Z','Rk','K','nu_k','nu_b','nu_n','Rb','B','N','C_fe','Rd_fe','Lambda_fe','I_fe','Q_fe','infl_fe','F_fe','Z_fe','Rk_fe','K_fe','nu_k_fe','nu_b_fe','nu_n_fe','Rb_fe','B_fe','N_fe', 'inflationq'};
%AL_Info.states_long  = {'c','cf','inve','invef','kp','kpf','inflationq','inflationqls','w','a','b','epinfma','ewma','g','qs','spinf','sw','interest'};
AL_Info.states_long  = {'interest','inflationq','inflationql','inflationql2','C','U_c','K','Q','I','Dis','Phi','N','Om','B','i','a','ksi','g','Y_fe','C_fe','U_c_fe','K_fe','Q_fe','I_fe','Dis_fe','Phi_fe','N_fe','Om_fe','B_fe','i_fe'};
...
AL_Info.states_short = {'interest','inflationq','inflationql','inflationql2','C','U_c','K','Q','I','Dis','Phi','N','Om','B','i','a','ksi','g','C_fe','U_c_fe','K_fe','Q_fe','I_fe','Phi_fe','N_fe','Om_fe','B_fe'};
