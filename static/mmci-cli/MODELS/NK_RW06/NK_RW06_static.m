function [residual, g1, g2, g3] = NK_RW06_static(y, x, params)
%
...
residual(4)= lhs-rhs;
lhs =y(4);
rhs =params(32)*x(2)+y(7)*params(22)+y(7)*params(21)+y(7)*params(20)+y(7)*params(19)+y(7)*params(18)+y(7)*params(17)+y(7)*params(16)+y(7)*params(15)+y(7)*params(14)+y(6)*params(13)+y(6)*params(12)+y(6)*params(11)+y(6)*params(10)+y(6)*params(6)+y(6)*params(5)+y(4)*params(1)+y(4)*params(2)+y(4)*params(3)+y(4)*params(4)+y(6)*params(7)+y(6)*params(8)+y(6)*params(9);
residual(5)= lhs-rhs;
lhs =y(1);
