function [residual, g1, g2, g3] = EA_SR07_static(y, x, params)
%
...
T312 = (-(1/params(113)));
T353 = params(73)^2;
T359 = (-(1/(T353+params(35)*params(70)^2)));
T400 = 1/(T353*params(69)*(1+params(35)));
...
residual(6)= lhs-rhs;
lhs =y(98);
rhs =params(32)*x(20)+y(102)*params(31)+y(102)*params(30)+y(102)*params(29)+y(102)*params(28)+y(102)*params(27)+y(102)*params(26)+y(102)*params(25)+y(102)*params(24)+y(102)*params(23)+y(101)*params(22)+y(101)*params(21)+y(101)*params(20)+y(101)*params(19)+y(101)*params(18)+y(101)*params(17)+y(101)*params(16)+y(101)*params(15)+y(101)*params(14)+y(100)*params(13)+y(100)*params(12)+y(100)*params(11)+y(100)*params(10)+y(100)*params(6)+y(100)*params(5)+y(98)*params(1)+y(98)*params(2)+y(98)*params(3)+y(98)*params(4)+y(100)*params(7)+y(100)*params(8)+y(100)*params(9);
residual(7)= lhs-rhs;
lhs =y(103);
rhs =params(34)*x(21);
residual(8)= lhs-rhs;
...
residual(19)= lhs-rhs;
lhs =y(7);
rhs =T400*(T353*params(69)*(params(35)*y(33)+y(7)+params(35)*y(7)-y(33))+y(9)-y(55))+y(40);
residual(20)= lhs-rhs;
...
residual(54)= lhs-rhs;
lhs =y(62);
rhs =y(40)+T400*(T353*params(69)*(params(35)*y(33)+y(62)+params(35)*y(62)-y(33))+y(64)-y(93));
residual(55)= lhs-rhs;
...
residual(78)= lhs-rhs;
lhs =y(28);
rhs =y(97)*params(234)+params(232)*x(3)+params(231)*x(4)+y(28)*params(207)+y(29)*params(208)+y(31)*params(209)+y(28)*params(216)+y(29)*params(217)+y(31)*params(218);
residual(79)= lhs-rhs;
lhs =y(29);
rhs =y(97)*params(239)+x(3)*params(237)+x(4)*params(236)+y(28)*params(210)+y(29)*params(211)+y(31)*params(212)+y(28)*params(219)+y(29)*params(220)+y(31)*params(221);
residual(80)= lhs-rhs;
lhs =y(31);
rhs =y(97)*params(249)+x(3)*params(247)+x(4)*params(246)+y(28)*params(213)+y(29)*params(214)+y(31)*params(215)+y(28)*params(222)+y(29)*params(223)+y(31)*params(224);
residual(81)= lhs-rhs;
lhs =y(24);
rhs =params(200)*x(19)+params(199)*x(18)+params(198)*x(17)+y(24)*params(162)+y(25)*params(163)+y(26)*params(164)+y(24)*params(171)+y(25)*params(172)+y(26)*params(173)+y(24)*params(180)+y(25)*params(181)+y(26)*params(182)+y(24)*params(189)+y(25)*params(190)+y(26)*params(191);
residual(82)= lhs-rhs;
lhs =y(25);
rhs =x(19)*params(203)+x(18)*params(202)+x(17)*params(201)+y(24)*params(165)+y(25)*params(166)+y(26)*params(167)+y(24)*params(174)+y(25)*params(175)+y(26)*params(176)+y(24)*params(183)+y(25)*params(184)+y(26)*params(185)+y(24)*params(192)+y(25)*params(193)+y(26)*params(194);
residual(83)= lhs-rhs;
lhs =y(26);
rhs =x(19)*params(206)+x(18)*params(205)+x(17)*params(204)+y(24)*params(168)+y(25)*params(169)+y(26)*params(170)+y(24)*params(177)+y(25)*params(178)+y(26)*params(179)+y(24)*params(186)+y(25)*params(187)+y(26)*params(188)+y(24)*params(195)+y(25)*params(196)+y(26)*params(197);
residual(84)= lhs-rhs;
residual(85) = y(94);
lhs =y(95);
rhs =x(19)*params(203)+x(18)*params(202)+y(94)*params(165)+y(95)*params(166)+y(96)*params(167)+y(94)*params(174)+y(95)*params(175)+y(96)*params(176)+y(94)*params(183)+y(95)*params(184)+y(96)*params(185)+y(94)*params(192)+y(95)*params(193)+y(96)*params(194);
residual(86)= lhs-rhs;
lhs =y(96);
rhs =x(19)*params(206)+x(18)*params(205)+y(94)*params(168)+y(95)*params(169)+y(96)*params(170)+y(94)*params(177)+y(95)*params(178)+y(96)*params(179)+y(94)*params(186)+y(95)*params(187)+y(96)*params(188)+y(94)*params(195)+y(95)*params(196)+y(96)*params(197);
residual(87)= lhs-rhs;
lhs =y(36);
rhs =x(5);
residual(88)= lhs-rhs;
...
T3 = (-1);
  ...
  g1(6,97)=T3;
  g1(6,103)=1;
  g1(7,98)=1-(params(4)+params(3)+params(1)+params(2));
  g1(7,100)=(-(params(13)+params(12)+params(11)+params(10)+params(9)+params(8)+params(7)+params(6)+params(5)));
  g1(7,101)=(-(params(22)+params(21)+params(20)+params(19)+params(18)+params(17)+params(16)+params(15)+params(14)));
  g1(7,102)=(-(params(31)+params(30)+params(29)+params(28)+params(27)+params(26)+params(25)+params(24)+params(23)));
  g1(8,103)=1;
  ...
  g1(20,7)=1-T353*params(69)*(1+params(35))*T400;
  g1(20,9)=(-T400);
  g1(20,33)=(-(T400*T353*params(69)*(params(35)-1)));
  g1(20,40)=T3;
  g1(20,55)=T400;
  g1(21,1)=(-params(39));
  ...
  g1(55,33)=(-(T400*T353*params(69)*(params(35)-1)));
  g1(55,40)=T3;
  g1(55,62)=1-T353*params(69)*(1+params(35))*T400;
  g1(55,64)=(-T400);
  g1(55,93)=T400;
  ...
  g1(79,28)=1-(params(207)+params(216));
  g1(79,29)=(-(params(208)+params(217)));
  g1(79,31)=(-(params(209)+params(218)));
  g1(79,97)=(-params(234));
  g1(80,28)=(-(params(210)+params(219)));
  g1(80,29)=1-(params(211)+params(220));
  g1(80,31)=(-(params(212)+params(221)));
  g1(80,97)=(-params(239));
  g1(81,28)=(-(params(213)+params(222)));
  g1(81,29)=(-(params(214)+params(223)));
  g1(81,31)=1-(params(215)+params(224));
  g1(81,97)=(-params(249));
  g1(82,24)=1-(params(189)+params(180)+params(162)+params(171));
  g1(82,25)=(-(params(190)+params(181)+params(163)+params(172)));
  g1(82,26)=(-(params(191)+params(182)+params(164)+params(173)));
  g1(83,24)=(-(params(192)+params(183)+params(165)+params(174)));
  g1(83,25)=1-(params(193)+params(184)+params(166)+params(175));
  g1(83,26)=(-(params(194)+params(185)+params(167)+params(176)));
  g1(84,24)=(-(params(195)+params(186)+params(168)+params(177)));
  g1(84,25)=(-(params(196)+params(187)+params(169)+params(178)));
  g1(84,26)=1-(params(197)+params(188)+params(170)+params(179));
  g1(85,94)=1;
  g1(86,94)=(-(params(192)+params(183)+params(165)+params(174)));
  g1(86,95)=1-(params(193)+params(184)+params(166)+params(175));
  g1(86,96)=(-(params(194)+params(185)+params(167)+params(176)));
  g1(87,94)=(-(params(195)+params(186)+params(168)+params(177)));
  g1(87,95)=(-(params(196)+params(187)+params(169)+params(178)));
  g1(87,96)=1-(params(197)+params(188)+params(170)+params(179));
  g1(88,36)=1;
