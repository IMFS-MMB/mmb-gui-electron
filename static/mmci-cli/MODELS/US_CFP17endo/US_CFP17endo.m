...
options_ = [];
M_.fname = 'US_CFP17endo';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('US_CFP17endo.log');
M_.exo_names = 'eps_a';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('US_CFP17endo_static');
erase_compiled_function('US_CFP17endo_dynamic');
...
save('US_CFP17endo_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('US_CFP17endo_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('US_CFP17endo_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('US_CFP17endo_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('US_CFP17endo_results.mat', 'estimation_info', '-append');
end
