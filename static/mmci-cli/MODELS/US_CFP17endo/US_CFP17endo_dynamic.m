function [residual, g1, g2, g3] = US_CFP17endo_dynamic(y, x, params, steady_state, it_)
%
...
T3 = (-1);
T183 = 1+params(36)*params(40)^2;
T340 = (-4)*(params(87)-params(41))/params(87);
T382 = params(88)/params(91);
T387 = T382*y(74)+y(72)*(1-T382);
...
residual(9)= lhs-rhs;
lhs =y(60);
rhs =(params(36)*params(40)*y(152)-T183*y(61)+params(40)*y(6))/((1-params(36)*params(40))*(1-params(40)))+y(42)*(1-params(36)*params(40)*params(81))/(1-params(36)*params(40));
residual(10)= lhs-rhs;
lhs =y(89);
rhs =y(42)*(1-params(36)*params(40)*params(81))/(1-params(36)*params(40))+(params(36)*params(40)*y(159)-T183*y(90)+params(40)*y(17))/((1-params(36)*params(40))*(1-params(40)));
residual(11)= lhs-rhs;
lhs =y(43);
...
residual(32)= lhs-rhs;
lhs =y(112);
rhs =T382*y(110)+y(103)*(1-T382)-y(104);
residual(33)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(10,61)=(-((-T183)/((1-params(36)*params(40))*(1-params(40)))));
  ...
  g1(11,90)=(-((-T183)/((1-params(36)*params(40))*(1-params(40)))));
