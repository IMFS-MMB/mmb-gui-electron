function [ys,params,check] =Fio2_Revision_Woodf_steadystate(ys,exo,M_,options_) %% added additional input, to prevent error for missing exogenous vars
check=0;
%% global cons_h_ss i_dep_ss  infl_ss  omeg_t_ss  s_t_ss  chi_t_ss  thet1_t_ss  thet2_t_ss  y_t_ss  spread_ss  q_t_ss  ygap_ss  cons_e_ss  mon_cost_ss Bankrupt_ss  fo_t_ss  ho_t_ss   Util_ss Welf_ss i_e_ss y_e_ss a_t_ss mu_t_ss i_l_ss credit_ss interest_1_ss tau_t_ss stdoi_t_ss
%global M_
