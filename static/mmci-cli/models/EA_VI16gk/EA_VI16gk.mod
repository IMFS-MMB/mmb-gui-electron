...
% Stefania Villa (2016). Financial frictions in the Euro Area and the United States: a Bayesian assessment
% Macroeconomic Dynamics, 20 (05), p. 1313-1340

% Last edited: 16/05/19 by F. Strobel
...
emp robs piobs dy dc dfi dw e_g
//**************************************************************************
// Modelbase Variables                                                   //*
...
g       = rho_G*g(-1)+e_g;            
eps_r   = rho_ri*eps_r(-1) + interest_;
...
var fiscal_; stderr 0.335;
var e_k; stderr 0.6017;
var interest_; stderr 0.2397;
...
stderr interest_,   0.1224 ,0.01,25,INV_GAMMA_PDF,0.1,2;
