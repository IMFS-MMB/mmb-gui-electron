...
// in paper theta=0.972
    // BGG specific
N_K       = 0.500;    // N/K, net worth-to-capital

// estimated parameters initialisation
// only posterior mean is given in the paper, so this is taken
...
rho_a     = 0.92;   // Persistency of technological shock
rho_k     = 0.97;
rho_g     = 0.95;
rho_x     = 0.96;   // Persistency of shock to K
rho_ri    = 0.27;
rho_p     = 0.32;
rho_w     = 0.17;
...
//k (capital) and n (net worth) are predetermined
